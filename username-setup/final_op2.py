...
output_file = os.path.join(input_folder, "final_output.json")  # Ensure output is saved in the same folder
...
# Save the combined data to the final JSON output file in the same folder
